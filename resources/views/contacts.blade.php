...
<head>
                        ...
                        <div class="col-xl-12">
                            <div class="row d-flex justify-content-between align-items-center">
                                <div class="header-info-left d-flex">
                                   ...
                                   <li><a  href="https://www.facebook.com/trodevit"><iclass="fabfa-facebook-f"><i></a></li>
                                            <li><a href="https://www.linkedin.com/company/trodev/
  ...
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart" aria-hidden="true"></i> by <a href="https://tordev.com" target="_blank">Trodev</a>
