                        ...
                        <div class="col-xl-12">
                            <div class="row d-flex justify-content-between align-items-center">
                                <div class="header-info-left d-flex">
                                    <ul>
                                        <li>Call Us: (+880) 1615257555</li>
                                        <li>admin@trodev.com </li>
                                    </ul>
                                    <div class="header-social">
                                        <ul>
                                            <li><a  href="https://www.facebook.com/trodevit"><i class="fab fa-facebook-f"></i></a></li>
                                            <li><a href="https://www.linkedin.com/company/trodev/"><i class="fab fa-linkedin-in"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="row justify-content-between">
                ...
                <div class="col-xl-6 col-lg-6 col-md-10">
                    <div class="about-caption mb-50">
                        ...
                        <p>Collaboration breeds synergy; together, we amplify ideas and achieve greatness. Listening fosters understanding, paving the path for a shared experience enriched by diverse perspectives. Our collective efforts culminate in an exceptional journey of growth and achievement.</p>
                    </div>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-5 col-sm-8">
                            <div class="single-footer-caption mb-50">
                                ...
                                <div class="footer-number">
                                    <h4><span>+880 </span>1615257555</h4>
                                    <p>admin@trodev.com</p>
                                </div>
                            </div>
                        </div>
  ...
  <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
                        ...
                        <div class="col-xl-3 col-lg-4">
                            ...
                            <div class="footer-social f-right">
                                <a href="https://www.linkedin.com/company/trodev/"><i class="fab fa-twitter"></i></a>
                                <a href="https://www.facebook.com/trodevit"><i class="fab fa-facebook-f"></i></a>
